...
const styles = StyleSheet.create({
  ...
  historyPeriod:     { fontSize: 13, fontWeight: '600', color: BRAND_COLORS.TEXT, fontFamily: 'Inter_600SemiBold', flexShrink: 1 },
  historyMethod:     { fontSize: 12, color: '#888', fontFamily: 'Inter_400Regular', flexShrink: 1 },
  historyRight:      { alignItems: 'flex-end', gap: 4, marginLeft: 8 },
